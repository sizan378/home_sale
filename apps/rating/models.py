...
from home_sale.settings.base import AUTH_USER_MODEL
...
class Rating(TimeStampedUUIDModel):
    ...
    home_rating = models.IntegerField(choices=Range.choices, help_text="1=Poor, 2=Fair, 3=Good, 4=Very Good, 5=Excellent")
    ...
    def __str__(self):
        return f"{self.agent} rated at {self.home_rating} "
